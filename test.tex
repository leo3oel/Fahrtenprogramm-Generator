...
\usepackage[a4paper, headheight=1.75cm, top=3.2cm,bottom=30mm, left=4.5cm, right=2cm, marginparwidth=4cm, marginparsep=.4cm]{geometry} 
...
\pagestyle{Allgemein}
\paragraph{Arbeitsdienst}\marginnote{20230101}
\begin{itemize}
...
\addcontentsline{toc}{chapter}{\protect\numberline{}Jugend}
\pagestyle{Jugend}
\paragraph{irgendwas für die jugend}\marginnote{20230304 - 20230307}
\begin{itemize}
...
\addcontentsline{toc}{chapter}{\protect\numberline{}Kanupolo}
\pagestyle{Kanupolo}
\paragraph{Boote flicken}\marginnote{202303016}
\begin{itemize}
    \item Ansprechpartner: Leo \href{sport@kc-wuerzburg.de}{mailto:sport@kc-wuerzburg.de}
    \item Boote flicken
\end{itemize}
